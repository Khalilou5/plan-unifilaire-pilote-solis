          ...
          >
            ...
            {(activeLevel === 'all' || activeLevel === 'ac-bt') && (
              <g id="niveau-tgbt">
                ...
                <text x="815" y="350" textAnchor="middle" fill="#ef4444" fontSize="10" fontWeight="bold">Q1</text>
            ...
            {(activeLevel === 'all' || activeLevel === 'ac-mv') && (
              <g id="niveau-pcc">
                ...
                <text x="1625" y="295" textAnchor="middle" fill="#9ca3af" fontSize="11">6.0 MW P Injectable</text>
